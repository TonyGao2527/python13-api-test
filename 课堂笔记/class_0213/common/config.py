...
if __name__ == '__main__':
    ...
    print(type(read_config.get('db', 'host')), read_config.get('db', 'host'))
    print(bytes(read_config.get('db', 'user')), read_config.get('db', 'user'))
    print(bytes(read_config.get('db', 'password')), read_config.get('db', 'password'))
    print(type(eval(read_config.get('db', 'port'))), eval(read_config.get('db', 'port')))
