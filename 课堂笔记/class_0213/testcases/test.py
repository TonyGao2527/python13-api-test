...
from common.url_comfig import ReadConfig
...
# main_url = ReadConfig(contants.case_config).get_value('UrlChange', 'url_1')

for case in cases:
    print("开始执第{0}行用例".format(case.case_id))
    # case_url = main_url + case.url
    # print('拼接后的url  case_url：', case_url)
    # print('原url  case.url', case.url)
    # 使用封装好的request 来完成请求
